...
export const CraftingWorkbench = () => {
    return (_jsxs("div", { className: "crafting-workbench", role: "application", "aria-label": "Tribal crafting workbench", children: [_jsxs("div", { className: "crafting-workbench__board", children: [_jsxs("header", { className: "crafting-workbench__status", children: [_jsx("div", { className: "crafting-workbench__party", "aria-label": "Party status", children: partyMembers.map((member) => (_jsxs("article", { className: "crafting-workbench__party-member", children: [_jsx("div", { className: "crafting-workbench__portrait", "aria-hidden": "true", children: member.portrait }), _jsxs("div", { className: "crafting-workbench__member-body", children: [_jsxs("div", { className: "crafting-workbench__member-header", children: [_jsx("h3", { children: member.name }), _jsx("span", { className: "crafting-workbench__member-role", children: member.role })] }), _jsx("ul", { className: "crafting-workbench__stat-list", children: member.stats.map((stat) => (_jsxs("li", { children: [_jsx("span", { className: "crafting-workbench__stat-label", children: stat.label }), _jsx("div", { className: "crafting-workbench__progress", role: "meter", "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": stat.value, "aria-label": `${stat.label} ${stat.value}%`, children: _jsx("span", { className: "crafting-workbench__progress-value", style: { width: `${stat.value}%`, background: stat.color } }) })] }, stat.label))) })] })] }, member.id))) }), _jsx("div", { className: "crafting-workbench__resources", "aria-label": "Tribe resources", children: resourceChips.map((resource) => (_jsxs("div", { className: "crafting-workbench__resource-chip", children: [_jsx("span", { className: "crafting-workbench__resource-icon", "aria-hidden": "true", children: resource.icon }), _jsxs("div", { children: [_jsx("span", { className: "crafting-workbench__resource-label", children: resource.label }), _jsxs("span", { className: "crafting-workbench__resource-value", children: [resource.value, _jsx("span", { className: `crafting-workbench__resource-delta ${resource.delta >= 0 ? 'is-positive' : 'is-negative'}`, children: resource.delta >= 0 ? `+${resource.delta}` : resource.delta })] })] })] }, resource.id))) })] }), _jsxs("div", { className: "crafting-workbench__tray", role: "region", "aria-labelledby": "work-tray-heading", children: [_jsx("h2", { id: "work-tray-heading", className: "crafting-workbench__tray-title", children: "Work Tray" }), _jsxs("div", { className: "crafting-workbench__tray-top", children: [_jsx("div", { className: "crafting-workbench__slot-group", "aria-label": "Ingredient slots", children: workTrayInputs.map((slot) => (_jsxs("div", { className: "crafting-workbench__slot", children: [_jsx("span", { className: "crafting-workbench__slot-icon", "aria-hidden": "true", children: slot.icon }), _jsxs("span", { className: "crafting-workbench__slot-qty", children: [slot.quantity, "x"] }), _jsx("span", { className: "crafting-workbench__slot-label", children: slot.label })] }, slot.id))) }), _jsx("div", { className: "crafting-workbench__slot-group", "aria-label": "Tool slots", children: workTrayTools.map((slot) => (_jsxs("div", { className: "crafting-workbench__slot crafting-workbench__slot--tool", children: [_jsx("span", { className: "crafting-workbench__slot-icon", "aria-hidden": "true", children: slot.icon }), _jsx("span", { className: "crafting-workbench__slot-label", children: slot.label })] }, slot.id))) }), _jsxs("div", { className: "crafting-workbench__slot crafting-workbench__slot--output", "aria-label": "Output slot", children: [_jsx("span", { className: "crafting-workbench__slot-icon", "aria-hidden": "true", children: workTrayOutput.icon }), _jsxs("span", { className: "crafting-workbench__slot-qty", children: [workTrayOutput.quantity, "x"] }), _jsx("span", { className: "crafting-workbench__slot-label", children: workTrayOutput.label })] })] }), _jsxs("div", { className: "crafting-workbench__tray-footer", children: [_jsx("div", { className: "crafting-workbench__categories", role: "tablist", "aria-label": "Recipe categories", children: categories.map((category) => (_jsxs("span", { role: "tab", "aria-selected": category.id === 'tools', className: `crafting-workbench__category${category.id === 'tools' ? ' is-active' : ''}`, children: [_jsx("span", { "aria-hidden": "true", children: category.icon }), category.label] }, category.id))) }), _jsx("button", { type: "button", className: "crafting-workbench__craft-button", children: "Craft Selected Recipe" })] })] })] }), _jsxs("section", { className: "crafting-workbench__inventory", role: "region", "aria-labelledby": "inventory-heading", children: [_jsxs("div", { className: "crafting-workbench__inventory-header", children: [_jsx("h2", { id: "inventory-heading", children: "Inventory" }), _jsx("span", { className: "crafting-workbench__inventory-capacity", children: "25 slots" })] }), _jsx("div", { className: "crafting-workbench__inventory-grid", role: "grid", "aria-readonly": "true", children: inventorySlots.map((slot, index) => (_jsx("div", { role: "gridcell", "aria-label": slot ? `${slot.label}, quantity ${slot.quantity}` : 'Empty slot', className: `crafting-workbench__inventory-slot${slot ? ' has-item' : ''}`, children: slot ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "crafting-workbench__inventory-icon", "aria-hidden": "true", children: slot.icon }), _jsx("span", { className: "crafting-workbench__inventory-qty", children: slot.quantity })] })) : (_jsx("span", { className: "crafting-workbench__inventory-empty", children: "Empty" })) }, `inventory-slot-${index}`))) })] })] }));
};
